...
def render(slug, title, description):
    ...
    nav = ''.join(link(key, label, slug) for key, label in [('product','Product'), ('community','Community'), ('get-started','Get started'), ('help','Help')])
    tokens = {
        ...
        'SCREENSHOT_WIDE': screenshot('windows-share', 'Native Windows app · Phosphor theme · September 7 development build. <a href="product.html#screenshots">About these captures</a>.', slug in ['index','product']),
...
<body>
  ...
  <dialog class="image-dialog" aria-label="Full-size app screenshot"><form method="dialog"><button class="button" aria-label="Close screenshot">Close <span aria-hidden="true">×</span></button></form><div class="image-scroll"><img alt=""></div><p>Actual native app · September 7 development build · Phosphor theme</p></dialog>
</body>
</html>
'''
